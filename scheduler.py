...
# from database import getAlertUsers, removeAlertUser, addAlertUser
# from response import alertEmbed

# count = 0

# async def onStartAlert(bot, schedulers, renewSchedulers):
#     users = getAlertUsers()
#     print(users)
#     for user in users:
...
#     await alertEmbed(bot, title, episode, imageUrl, channelId, discordId)
